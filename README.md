...
![HTTPS ReadMe Logo](images/HTTPS_ReadMe_Logo.png)
...
## :blue_book: _Specification for Transfer of OpenC2 Messages Via HTTPS_ :blue_book:

This specification provides guidance to the OpenC2 implementation
community when utilizing HTTPS for OpenC2 message transport.
