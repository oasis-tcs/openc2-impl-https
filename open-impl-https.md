...
Because the HTTP protocol requires the server send a response, the OpenC2 command argument `response_requested` SHOULD NOT be populated with the `none` option.
